...
import re
import requests
from xbmctorrent.utils import terminating, get_quality_from_name
...
def kickass_search():
    ...
    if query:
        ...
        kb = xbmc.Keyboard("", "XBMCtorrent - Kickass Torrent - Search")
        kb.doModal()
