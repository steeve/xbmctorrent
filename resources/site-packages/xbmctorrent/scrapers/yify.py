...
@scraper("Watch Movies on YIFY Torrents", "http://fbcdn-sphotos-h-a.akamaihd.net/hphotos-ak-frc3/204323_207963335901313_5804989_o.jpg")
@plugin.route("/yify")
@tracked
def yify_index():
    return [
        ...
        # {"label": "Most Popular HD 720p", "path": plugin.url_for("yify_show", sort="seeds", order="desc", quality="720p", set=1, limit=20)},
        # {"label": "Most Popular HD 1080p", "path": plugin.url_for("yify_show", sort="seeds", order="desc", quality="1080p", set=1, limit=20)},
        # {"label": "Most Popular 3D", "path": plugin.url_for("yify_show", sort="seeds", order="desc", quality="3D", set=1, limit=20)},
        # {"label": "Best Rated HD 720p", "path": plugin.url_for("yify_show", sort="seeds", order="desc", quality="720p", set=1, limit=20)},
        # {"label": "Best Rated HD 1080p", "path": plugin.url_for("yify_show", sort="seeds", order="desc", quality="720p", set=1, limit=20)},
        # {"label": "Best Rated 3D", "path": plugin.url_for("yify_show", sort="seeds", order="desc", quality="720p", set=1, limit=20)},
    ...
    with closing(xbmcgui.DialogProgress()) as dialog:
        ...
        def on_movie(data):
            ...
            dialog.update(
                ...
                line1="Fetching movie metadata...",
                line2=data.get("title") or data.get("MovieTitleClean") or "",
            )

        with nested(closing(ThreadPool(2)), closing(ThreadPool(2))) as (pool_yify, pool_tmdb):
